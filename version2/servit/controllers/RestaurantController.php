...
class RestaurantController extends ActiveController
{
    ...
    public function actionCodigo(){
        ...
        */
        ...
        $idZona = $request->getBodyParam('zona');
        $idSeccion = $request->getBodyParam('seccion');
    ...
    public function actionEliminarProducto(){
        ...
        $username = $request['username'];*/
        $request = Yii::$app->request;
        $id = $request->getBodyParam('id_producto');
        $username = $request->getBodyParam('username');
    ...
    public function actionAddPedido(){
        ...
        $request = Yii::$app->request;
        $id = $request->getBodyParam('id_producto');
        $cantidad = $request->getBodyParam('cantidad');
        $username = $request->getBodyParam('username');
        $pedido = Pedido::findOne(['username' => $username, 'estado' => '0']);
        if($pedido == null){
    ...
    public function actionValoracion(){
        ...
        $request = Yii::$app->request;
        $username = $request->getBodyParam('username');
        $recomendarias = $request->getBodyParam('recomendarias');
        $repetirias = $request->getBodyParam('repetirias');
        $ambiente = $request->getBodyParam('ambiente');
        $experiencia = $request->getBodyParam('experiencia');
    ...
    public function actionEditarPerfil(){
        ...
        $request = Yii::$app->request;
        $username = $request->getBodyParam('username');
        $provincia = $request->getBodyParam('provincia');
        $anioNacimiento = $request->getBodyParam('anioNacimiento');
        $nombre = $request->getBodyParam('nombre');
        $apellidos = $request->getBodyParam('apellidos');
    ...
    public function actionEditarValoracion(){
        ...
        $ambiente = $request->getBodyParam('ambiente');
        $experiencia = $request->getBodyParam('experiencia');
        $id_zona = $request->getBodyParam('id_zona');
        $numero = $request->getBodyParam('seccion');
        $datetime = $request->getBodyParam('datetime');
        $atiende = Atiende::findOne(['username' => $username, 'id_zona' => $id_zona, 'numero' => $numero, 'datetime' => $datetime]);
        $atiende->recomendaria = $recomendarias;
        $atiende->repetiria = $repetirias;
        $atiende->experiencia = $experiencia;
        $atiende->ambiente = $ambiente;
        $atiende->save();
    }
    ...
    public function actionSolicitarCuenta(){
        $request = Yii::$app->request;
        $username = $request->getBodyParam('username');
        $propina = $request->getBodyParam('propina');
        $precio_total = $request->getBodyParam('precio_total');
        /*$username = $request['username'];
