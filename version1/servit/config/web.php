...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'TfkJibAUYyQyBEUhk2VV613la4in9H_k',
            'parsers' => [
        ...
        'user' => [
            'identityClass' => 'app\models\Propietario',
        ...
        'mailer' => [
            ...
            'transport' => [
                ...
                'username' => 'servitcontacto@gmail.com',
                'password' => 'servitadmin',
        ...
        'urlManager' => [
            ...
            'rules' => [
                ['class' => 'yii\rest\UrlRule', 'controller' => ['restaurant', 'usuario']],
            ],
        ],
