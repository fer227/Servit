...
<div class="container">
    ...
    <?= $form->field($model, 'username', ['template' => '<div class="input-field"><i class="material-icons prefix">account_circle</i>{label}{input}{hint}{error}</div>'])->textInput(['autofocus' => true]) ?>
